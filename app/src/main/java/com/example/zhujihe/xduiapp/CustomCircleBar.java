...
/**
 * Created by zhujihe on 2018/1/8.
 */

public class CustomCircleBar extends View {
    private static final String TAG = "CustomCircleBar";
    ...
    private int mTextColor = getResources().getColor(R.color.color_blue);//默认文字颜色
    private int mWheelColor = getResources().getColor(R.color.color_blue);//默认圆环颜色
    ...
    public CustomCircleBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mDefaultWheelPaint.setColor(getResources().getColor(R.color.color_gray));
        ...
        textDesPaint.setColor(getResources().getColor(R.color.color_gray));
